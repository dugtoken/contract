 ...
 * #DUG 
 * Website :  http://www.DUGtoken.com/
 * 
 * #DUG is made to be fully transferred to its beloved community.
 * 
 * #DUG community is completely organic and will work hard as a community to make each member crypto-rich.
 * 
 ...
 * 
 * 2% Fee is Automatically burned
 * 3% Fee is Automatically added to Liquidity Pool.
 * 2% Fee is Automatically redistributed to holders.
 * 3% Fee is Automatically sent to Marketing Wallet. 
 * 
 * ( Marketing wallet is transparent and used only for the development and marketing of the project for the benefit and growth of the $DUG community )
 * 
 * 
 ...
 * We are not affiliated with any other groups, projects or teams. We are the original $DUG team.
...
contract DUG is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x2315150d66e7551DE723976A70B90968f6219117;
